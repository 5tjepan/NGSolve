...
mesh = Mesh(OCCGeometry(geo, dim=2).GenerateMesh(maxh=0.00003, quad_dominated=False))
...
APow= (0.5/sigma*(1/int_Km * int_jabs_sqr))
babs_sqr=(B.Norm())**2
int_babs_sqr = Integrate(rel*babs_sqr, mesh, definedon=defon)
RPow = (0.5*omega*(1/int_Km * int_babs_sqr))
print('ActivePower=',APow)
print('ReactivePower=',RPow)

reMIeff=2/omega/abs(b_bar)**2 * RPow
print('reMIeff=', reMIeff)
imMIeff=2/omega/abs(b_bar)**2 *APow
print('imMIeff=', imMIeff)
