...
if flag==True:
    Apot_dirich= "l0|t0|t1|t2|t3|t4|t5|t6|t7|t8|r8|b0|b1|b2|b3|b4|b5|b6|b7|b8|rub|Kml|Kmt|Kmr|Kmb"
    Tpot_dirich= "l0|r0|l1|r1|l2|r2|l3|r3|l4|r4|l5|r5|l6|r6|l7|r7|l8|r8|rub|Kml|Kmr"
    Svi_dirich= "l0|r0|l1|r1|l2|r2|l3|r3|l4|r4|l5|r5|l6|r6|l7|r7|l8|r8|t0|t1|t2|t3|t4|t5|t6|t7|t8|b0|b1|b2|b3|b4|b5|b6|b7|b8|rub|Kml|Kmr"
    Asvi_dirich= "l0|r0|l1|r1|l2|r2|l3|r3|l4|r4|l5|r5|l6|r6|l7|r7|l8|r8|t0|t1|t2|t3|t4|t5|t6|t7|t8|b0|b1|b2|b3|b4|b5|b6|b7|b8|rub|Kml|Kmr|Kmt|Kmb"
...
#Hfe = (-8000*(0.5*x**2 - 2*w*x - w**2/6)*0 - 0.5/fill_fact)/mu
Hfe = (50*x - 0.5/fill_fact)/mu
#Hfe = -0.287862 /fill_fact
#Bfe = 0.5 /fill_fact
...
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
#f_Km = CF(1)
f_Km = IfPos( (x+w/3)*(x+w), 0, IfPos((y-h/3)*(y-h), 0, 1))
Draw (f_Km, mesh, "f_Km")
...
Pow_analitik =sigma*omega**2*delta*d/8*(sinh(d/delta)-sin(d/delta))/(cosh(d/delta)-cos(d/delta))* (abs(b_bar)/fill_fact)**2
...
print('')
print(round(omega/2/pi), round(delta/d, 3), round(nuzz.real,1), round(nuzz.imag,1), round(Pcoeff))
