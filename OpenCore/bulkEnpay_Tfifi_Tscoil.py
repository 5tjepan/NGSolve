...
fsU = H1(mesh, order=1, dirichlet="bottom|top|left", definedon='core', complex=True) #bez right!
...
for i in range(1,2):
    ...
    #Ts_total = 1j*omega*mu*Ts_coil *grad(psi)*dx("coil") + 1j*omega*mu*Ts_air *grad(psi)*dx('air|core')
