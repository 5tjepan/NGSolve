...
size= d/8 #0.0118 #0.0059 #0.00145 #0.00046  #0.00156 #0.0008
...
for ind in range(1,17):
    ...
    ffun= (zaf-1.0*favg)/rel #  #vjerojatno NIJE minus! ??????
    ...
    #term1a= 1j*omega*theta*ffun* (rot*grad(csp))*ag*dx(bonus_intorder=2)
